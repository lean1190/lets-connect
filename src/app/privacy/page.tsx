        ...
        <div className="bg-white rounded-lg shadow-lg p-8">
          ...
          <div className="bg-green-50 border-l-4 border-green-400 p-6 mb-8">
            ...
            <ul className="text-green-800 space-y-2">
              <li>
                • We collect only the information you provide (name, email, gym,
                schedule, fitness goals)
              </li>
              <li>
                • Your data is used solely to match you with compatible workout
                partners
              </li>
              <li>
                • We don't sell, rent, or share your personal information with
                third parties
              </li>
              <li>• You can delete your account and data anytime</li>
              <li>
                • We use secure databases and follow industry best practices
              </li>
              <li>
                • We may send you emails about matches and service updates
              </li>
            </ul>
          </div>
          ...
          <div className="prose prose-lg max-w-none">
            ...
            <p className="text-gray-700 mb-4">
              We collect information you voluntarily provide when creating your
              PushPal profile:
            </p>
            <ul className="list-disc list-inside text-gray-700 mb-6 space-y-2">
              ...
              <li>
                <strong>Fitness Information:</strong> Age, gender, fitness
                level, goals, bio
              </li>
              <li>
                <strong>Location Information:</strong> Gym location and workout
                schedule
              </li>
              <li>
                <strong>Usage Data:</strong> How you interact with the service,
                matches made, feedback provided
              </li>
            </ul>
            ...
            <p className="text-gray-700 mb-4">
              We use your information solely to provide and improve the PushPal
              service:
            </p>
            <ul className="list-disc list-inside text-gray-700 mb-6 space-y-2">
            ...
            <ul className="list-disc list-inside text-gray-700 mb-6 space-y-2">
              <li>
                <strong>With Matched Users:</strong> When you're matched with
                someone, they can see your name, fitness level, goals, and bio
              </li>
              <li>
                <strong>Service Providers:</strong> We use trusted third-party
                services (like email providers) that help us operate the service
              </li>
              <li>
            ...
            <ul className="list-disc list-inside text-gray-700 mb-6 space-y-2">
              ...
              <li>
                We use secure, industry-standard databases and hosting services
              </li>
            ...
            <ul className="list-disc list-inside text-gray-700 mb-6 space-y-2">
              <li>
                <strong>Access:</strong> You can view and update your profile
                information anytime
              </li>
              <li>
              ...
              <li>
                <strong>Communication:</strong> You can opt out of non-essential
                emails
              </li>
              <li>
            ...
            <ul className="list-disc list-inside text-gray-700 mb-6 space-y-2">
              ...
              <li>
                Legal requirements: Some data may be retained longer if required
                by law
              </li>
            </ul>
            ...
            <p className="text-gray-700 mb-6">
              PushPal is intended for users 18 years and older. We do not
            ...
            <p className="text-gray-700 mb-6">
              If you're using PushPal from outside the Germany, please note that
              your information may be transferred to and processed in the
              Germany. By using our service, you consent to this transfer.
            </p>
            ...
            <p className="text-gray-700 mb-6">
              ...
              service. Continued use of PushPal after changes constitutes
            ...
            <p className="text-gray-700 mb-6">
              ...
              your information, please contact us through the feedback
              mechanisms provided in the app.
            </p>
