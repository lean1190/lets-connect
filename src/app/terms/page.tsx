      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="bg-white rounded-lg shadow-lg p-8">
          ...
          <div className="bg-blue-50 border-l-4 border-blue-400 p-6 mb-8">
            <h2 className="text-lg font-semibold text-blue-900 mb-3">TL;DR - Quick Summary</h2>
            <ul className="text-blue-800 space-y-2">
              <li>• PushPal is a free service that connects gym buddies</li>
              <li>• We match you with potential workout partners based on your preferences</li>
              <li>• You're responsible for your own safety and interactions with other users</li>
              <li>• We're not liable for any issues that arise from using our service</li>
          ...
          <div className="prose prose-lg max-w-none">
            ...
            <p className="text-gray-700 mb-6">
              By accessing and using PushPal ("the Service"), you accept and agree to be bound by
            ...
            <p className="text-gray-700 mb-6">
              PushPal is a platform that connects individuals seeking workout partners at gyms. We
              facilitate introductions between users based on shared gym locations, schedules, and
              fitness goals. The service is provided free of charge.
            </p>

            <h2 className="text-2xl font-semibold text-gray-900 mb-4">3. User Responsibilities</h2>
            <p className="text-gray-700 mb-4">As a user of PushPal, you agree to:</p>
            ...
            <p className="text-gray-700 mb-4">
              <strong>IMPORTANT:</strong> PushPal and its operators shall not be liable for any
              direct, indirect, incidental, special, consequential, or punitive damages, including
              but not limited to:
            </p>
            <ul className="list-disc list-inside text-gray-700 mb-6 space-y-2">
              <li>
                Personal injuries or accidents that occur during or after meetings arranged through
                the service
              </li>
            ...
            <p className="text-gray-700 mb-6">
              You use PushPal at your own risk. We are not responsible for the actions, behavior, or
              conduct of other users.
            </p>

            <h2 className="text-2xl font-semibold text-gray-900 mb-4">5. No Warranty</h2>
            <p className="text-gray-700 mb-6">
              PushPal is provided "as is" without any warranties, express or implied. We do not
              guarantee the accuracy, reliability, or availability of the service. We make no
              representations about the suitability of matches or the success of any connections
              made through our platform.
            </p>

            <h2 className="text-2xl font-semibold text-gray-900 mb-4">6. User-Generated Content</h2>
            <p className="text-gray-700 mb-6">
              You are solely responsible for any content you share through PushPal. You agree not to
              share inappropriate, offensive, or illegal content. We reserve the right to remove
            ...
            <p className="text-gray-700 mb-6">
              We may update these Terms & Conditions at any time. Continued use of PushPal after
            ...
            <p className="text-gray-700 mb-6">
              ...
              feedback mechanisms provided in the app.
            </p>
